  ...
  return (
    <div style={{ background: '#0F172A', color: '#F8FAFC' }}>
      ...
      <div style={{
        ...
        <a href="#pricing" style={{ color: 'white', textDecoration: 'underline', textUnderlineOffset: 2 }}>
          Free to Start →
        </a>
      </div>
      ...
      <section id="pricing" style={{ padding: '100px 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <h2 className="section-title" style={{ color: '#F8FAFC' }}>Simple, transparent pricing</h2>
